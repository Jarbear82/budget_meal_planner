                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .border_color(cx.theme().border)
                            .rounded_xl()
                            .child(div().text_sm().font_weight(FontWeight::BOLD).child("App Security & Privacy"))
                            .child(div().text_xs().text_color(cx.theme().muted_foreground).child("Local database encryption active. All data remains 100% on-device.")),
                    ),
            )
    }
}
